...
namespace Ubxty\CoreAi\Providers\OpenAI\Facades;
...
/**
 * @method static \Ubxty\CoreAi\Standards\OpenAI\OpenAIClient client(?string $connection = null)
 ...
 *
 * @see \Ubxty\CoreAi\Providers\OpenAI\OpenAiManager
 */
class OpenAiAi extends Facade
{
    protected static function getFacadeAccessor(): string
    {
        return OpenAiManager::class;
    }
}
